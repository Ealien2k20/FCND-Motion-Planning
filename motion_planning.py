...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        lat0 = float(values[0].split()[-1])
        lon0 = float(values[1].split()[-1])
        ...
        global_goal = [0,0,0]
        global_goal[0] = -122.399348
        global_goal[1] = 37.794750
